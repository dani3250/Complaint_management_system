...
<body id="<?= basename($_SERVER['PHP_SELF'], ".php")?>">
  ...
  <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add New Ticket
</button>
                        </h1>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> New Tickets
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <?php
                        ...
                        while ($record = mysql_fetch_array($ans))
                      {
                            ...
                            echo '<td><button type="button" class="bton btn btn-default " data-toggle="modal" data-target="#myModal">
